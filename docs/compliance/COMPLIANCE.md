...
- **Personal data processed:** — <!-- yes/no + what and why; if yes, GDPR rows below -->
- **AI features:** — <!-- yes/no + which; if yes, AI Act rows below -->
- **Applicable regimes:** —

| # | Regime | Obligation | Status | Evidence / where implemented |
|---|---|---|---|---|
| C-1 | — | — | open / met / blocked / n/a | — |
