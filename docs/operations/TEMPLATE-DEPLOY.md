...
<!-- TEMPLATE: the blank deploy runbook, and the file `begin` copies over Groundwork's own
     (`cp docs/operations/TEMPLATE-DEPLOY.md docs/operations/deploy.md`) so a new project does not
     inherit the framework's release route.
